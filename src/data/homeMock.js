...
export const homeInStoreHelp = {
    label: "پرداخت در خرید حضوری",
};

export const inStoreScan = {
    title: "پرداخت حضوری",
    helpTitle: "اسکن کد QR پوز فروشگاه",
    helpBody:
        "کیوآر کد پرداخت روی دستگاه پوز فروشگاه را داخل کادر قرار دهید. بعد از شناسایی فروشگاه، مبلغ را بررسی کنید و پرداخت را انجام دهید.",
};

export const mockStoreDetail = {
    pageTitle: "جزئیات فروشگاه",
    name: "چرم منط",
    subtitle: "انواع کیف، کفش",
    purchaseTypes: ["خرید اعتباری", "خرید با وام", "خرید با بارکد"],
    heroImage: "/banners/banner2.jpg",
    inStoreSectionTitle: "خرید حضوری",
    introSectionTitle: "معرفی فروشگاه",
    intro:
        "چرم منط با شعار «You Smile I Smile» پا به عرصه گذاشته تا حس خوب و زیبایی را با شما به اشتراک بگذارد. کیف و کفش‌های چرم منط، آثار هنری دست‌دوز از چرم طبیعی و اصیل هستند که با الهام از طبیعت و دقت هنرمندانه خلق شده‌اند. این محصولات، ترکیبی از اصالت، شخصیت و کارکردی ماندگارند که استایل شما را خاص و متفاوت می‌کنند.",
    address: "تهران، خیابان پاسداران، نبش گلستان یکم",
    phone: "۰۲۱-۲۲۵۴ ۶۸۰۰",
    phoneDial: "+982122546800",
    hours: "هر روز ۱۰ تا ۲۲",
    branch: {
        name: "شعبه پاسداران",
        address: "پاسداران، بین گلستان یکم و دوم",
